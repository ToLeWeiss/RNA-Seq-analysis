...
# ggsave(filename="MX1.png", plot = MX1, device= "png", dpi=600, height=10, width=14, units="in")
...
# ggsave(filename="MX1_MX2.png", plot= MX1_MX2, device= "png", dpi=600, height=10, width=14, units="in")
